...
## Integrating Strawberry GraphQL with Relay for Persisted Queries
...
First, ensure you have Relay set up on your client side. You can do this by configuring your Relay environment. Make sure to specify the URL for the persisted query configuration:
